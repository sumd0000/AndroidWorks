...
public class AREditor extends RelativeLayout {
     ...
     */
    private HorizontalScrollView mAreScrollView;
    ...
    private void initGlobal() {
      ...
      /*  LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(
        ...
        this.mToolbar.addView(this.mToolbar,layoutParams);
        this.mToolbar.setId(R.id.are_toolbar);*/

        this.mAreScrollView = new HorizontalScrollView(mContext);
    ...
    private void addEditText(boolean isBelow, int belowId) {
        ...
        LayoutParams scrollViewLayoutParams = new LayoutParams(LayoutParams.MATCH_PARENT,LayoutParams.WRAP_CONTENT );
        if (isBelow) {
        ...
        editTextLayoutParams.setMargins(0,0,0,40);
